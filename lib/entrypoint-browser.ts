import type { ICypressConfiguration } from "@badeball/cypress-configuration";
...
import type { AddOptions } from "./add-cucumber-preprocessor-plugin";
...
export type { IPreprocessorConfiguration };
